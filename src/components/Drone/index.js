...
const Drone = ({ connected }) => {
  let classes = 'drone-connecting';
  if (connected) classes = 'drone-connected';

  return (
    <svg viewBox="0 0 100 100" className="drone">
      <g>
        ...
        />
        <path className={classes} d="M7.4,36.6c1,0,5.7-0.4,9.2-1c1.3-0.2,2.7-0.2,4.1,0c3.5,0.6,8.2,1,9.2,1c1.5,0,2.8-1.1,2.8-2.4c0-1.3-1.3-2.4-2.8-2.4
          c-1,0-5.7,0.4-9.2,1c-1.3,0.2-2.7,0.2-4.1,0c-3.5-0.6-8.2-1-9.2-1c-1.5,0-2.8,1.1-2.8,2.4C4.6,35.5,5.9,36.6,7.4,36.6z"
        />
        <path className={classes} d="M92.6,31.7c-1,0-5.7,0.4-9.2,1c-1.3,0.2-2.7,0.2-4.1,0c-3.5-0.6-8.2-1-9.2-1c-1.5,0-2.8,1.1-2.8,2.4c0,1.3,1.3,2.4,2.8,2.4
